...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\columnwidth]{figures/evaluation_radar.png}
\caption{Radar chart comparing \foam{} (DebaterHub), human expert baselines (Debate Camps), and zero-shot AI models across six evaluation dimensions. \foam{} outperforms baselines on Overall Score, Argumentation, Evidence, and Coherence, with particularly strong gains in Evidence quality.}
\Description{Six-axis radar chart with three overlapping polygons representing FOAM (DebaterHub), Debate Camps (human experts), and zero-shot AI models. The six axes are Overall Score, Argumentation, Evidence, Coherence, Innovation, and Viability. FOAM shows the largest polygon area, substantially outperforming on Evidence and Argumentation axes. Human experts form a medium-sized polygon, while zero-shot AI shows the smallest polygon with particularly weak Evidence scores.}
