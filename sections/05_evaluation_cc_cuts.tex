...
\textbf{Main outcomes.} Table~\ref{tab:main-results} reports aggregate performance. \foam{} achieved overall score \textbf{81.7} vs.\ human experts \textbf{70.1} and zero-shot AI \textbf{50.6}. The largest gap: \textbf{Evidence Quality} (\textbf{86.7} vs.\ \textbf{56.9} vs.\ \textbf{27.1}).
